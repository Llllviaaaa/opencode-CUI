...
interface QuestionCardProps {
    part: MessagePart;
    onAnswer?: (answer: string, toolCallId?: string, subagentSessionId?: string, questionId?: string) => void;
}
...
export const QuestionCard: React.FC<QuestionCardProps> = ({ part, onAnswer }) => {
    ...
    const handleSelect = (label: string) => {
        ...
        onAnswer?.(label, part.toolCallId, part.subagentSessionId, part.questionId);
    };
    ...
    const handleSubmit = () => {
        ...
        onAnswer?.(answer, part.toolCallId, part.subagentSessionId, part.questionId);
    };
